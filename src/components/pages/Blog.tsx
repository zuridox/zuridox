...
const Blog: React.FC = () => {
  ...
  return (
    <div
      className={`w-full px-4 py-8 pt-20 ${theme === "dark" ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"}`}
    >
      <header className="text-center mb-12">
        ...
        <p
          className={`text-gray-600 mt-2 ${theme === "dark" ? "text-gray-400" : "text-gray-600"}`}
        >
